...
def label_text(pdf, w=0, t="", b="TBL", ln=3, f=False, lh=1, a="L", c=": "):
    pdf.set_font("Helvetica")
    pdf.multi_cell(w, line_height * lh, f" {t} {c}", border=b, ln=ln, fill=f, align=a)


def value_text(pdf, w=0, t="", b="TRB", ln=3, f=False, a="L"):
...
def create_pdf(data):
    ...
    label_text(pdf, 42, "Booking Confirmed On", 1, f=True)
    value_text(pdf, 28, booking_confirm_date, 1, f=True)
    ...
    label_text(pdf, 73, "Cooking Demo", a="C", c="")
    # pdf.multi_cell(74, line_height, "  ", border=1, ln=1, align="C")
    label_text(pdf, 74, "Market Visit", "LR", a="C", c="", ln=1)

    # pdf.multi_cell(43, line_height, "", ln=3)
    value_text(pdf, 43, "", 0)
    # pdf.multi_cell(73, line_height, f" {} ", border=1, ln=3, align="C")
    value_text(pdf, 73, cooking_demo, "LR", a="C")
    # pdf.multi_cell(74, line_height, f" {} ", border=1, ln=1, align="C")
    value_text(pdf, 74, market_visit, a="C", ln=1)

    # Driver
    # pdf.multi_cell(0, line_height, f"  : {}", border=1, ln=1)
    label_text(pdf, 60, "Driver accommodation required")
    value_text(pdf, 130, driver_accommodation, ln=1)
