...
pdf.write(5.5, "In light of the COVID-19 pandemic, we have amended our policies to ensure the safety of our guests and "
...
add_li("Health checks: All staff have received extensive training on COVID-19 mitigation and are monitored for health "
...
add_li("Enhanced cleaning and operational procedures: Our team uses approved veridical and antibacterial cleaning and"
...
add_li("Early check-ins by appointment only. Due to our stringent and lengthy housekeeping procedures, reduced desk "
